...
#Читаем dicom файлы
dicom_dir = 'C:/Users/k.zhukov/Desktop/Диплом/Фантом_1/Фантом_1_снимки'
# dicom_dir = '/home/kirill_zh/folder_py/test/'
# output_dir = 'C:/Users/k.zhukov/Desktop/Диплом/Фантом_1/Фантом_1_результаты/Весь_фантом/Средний_радиус_вект_ошибка'
...
# Сортировка и расчет ошибок для радиуса и координаты    
    ...
    for (x, y), r_ref, err in zip(reference_positions, reference_radii, radius_errors):
        ...
        circle = Circle(
            ...
            color=cmap(norm(err)),
            alpha=1,
            linewidth=1          # Убираем обводку
        )
        ax.add_patch(circle)
        plt.text(x, y, f'{err:.2f}', ha='center', va='center', fontsize=12, color='#555555', fontweight='bold')
        # plt.text(x, y, f'{ii}', ha='center', va='center', fontsize=15, color='#555555', fontweight='bold')
        ii += 1
